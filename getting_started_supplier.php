...
<html lang="en-US"  data-menu="leftalign">
	<head>		
		<title>Rentalz | Supplier Getting Started</title>
		<style type="text/css">
		img.wp-smiley,
		img.emoji {
  ...
  <body class="page-template page-template-page_r page-template-page_r-php page page-id-2650">
		...
		<?php
			include ("header.php");
			$get_info = mysqli_query($mysqli,"select * from getting_started where started_id = '2'");
     ...
     <div id="page_caption" class="hasbg parallax  withtopbar  " style="background-image:url(images/truck-parts-dubai.jpg);height:400px;" >
