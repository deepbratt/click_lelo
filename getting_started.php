...
<html lang="en-US"  data-menu="leftalign">
	<head>		
		<title>Supplier FAQ | Rentalz</title>
		<style type="text/css">
		img.wp-smiley,
		img.emoji {
        ...
        <div class="page_title_wrapper">
          <div class="page_title_inner">
            <div class="page_title_content">
              <h1 class ="withtopbar">Getting started
              </h1>
            </div>
          </div>
        </div>
          ...
          <div class="inner_wrapper">
            <div class="sidebar_content full_width nopadding">
              <div class="sidebar_content page_content">
                ...
                <div class="pp_accordion_open">
                  <h3>
                    Getting started
                  </h3>
                  <div>
                    <p style="font-size:18px;">
						Rentalz is a 2-sided marketplace for equipment rentals.  Rentalz does not own any equipment, but has assembled a network of suppliers who rent equipment through the Rentalz platform.<br><br>

						Rentalz makes it simple to schedule rentals online.  Equipment you see listed on the website has been uploaded by our suppliers and is available for immedate scheduling.  We call this equipment RentNow.<br><br>

						Some times you don’t know exactly what equipment you need.  In that situation, you can receive recommendations from our supplier network by requesting quotes (RFQs).<br><br>

						Upon securing your rental, Rentalz facilitates scheduling, billing, logistics, insurance, documentation and extensions by creating a Rental Workspace.  Our suppliers will handle the equipment delivery, technical support and other services if needed.<br>
                    </p>
                  </div>
                </div>
				<p>&nbsp;</p>
