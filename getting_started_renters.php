...
<html lang="en-US"  data-menu="leftalign">
	<head>		
		<title>Rentalz | Renters Getting Started</title>
		<style type="text/css">
		img.wp-smiley,
		img.emoji {
  ...
  <body class="page-template page-template-page_r page-template-page_r-php page page-id-2650">
		...
		<?php
			include ("header.php");
			$get_info = mysqli_query($mysqli,"select * from getting_started where started_id = '1'");
     ...
     <div id="page_caption" class="hasbg parallax  withtopbar  " style="background-image:url(images/daimler-trucks-north-america-presents-the-all-new-freightliner-cascadia-its-mo_2.jpg);height:400px;" >
        <div class="page_title_wrapper">
          <div class="page_title_inner">
            <div class="page_title_content">
              <h1 class ="withtopbar"><?php echo $fetch_info['title'];?></h1>
              <div class="page_tagline"><?php echo $fetch_info['sub_title'];?></div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="inner_wrapper">
            <div class="sidebar_content full_width nopadding">
              <div class="sidebar_content page_content">
				<?php echo $fetch_info['description'];?>		
			</div>
